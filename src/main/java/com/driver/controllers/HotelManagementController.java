...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel){
        ...
        catch (EmptyObjectHotelException e){
            return "FAILURE";
        }
    ...
    public Integer addUser(@RequestBody User user){
        ...
        int aadharCardNo = hotelService.addUser(user);
        return aadharCardNo;
    }
    ...
    public String getHotelWithMostFacilities(){
        ...
        String hotelName = hotelService.getHotelWithMostFacilities();
        return hotelName;
    }
    ...
    public int getBookings(@PathVariable("aadharCard") Integer aadharCard)
    {
        ...
        int bookingByPerson = hotelService.getBookingsByAPerson(aadharCard);
